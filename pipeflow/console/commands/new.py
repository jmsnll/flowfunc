...
class NewCommand(Command):
    ...
    def handle(self) -> int:
        ...
        readme_text = textwrap.dedent(f"""\
            ...
            {meta_description or "This workflow bundle contains a pipeflow pipeline."}

            ## How to Run

            ```bash
            uvx pipeflow run {workflows_base.name}/{name} --inputs '{{"example_global_input": "custom_value"}}'
            ```
        """)
