...
def test_mapspec_broadcast_mode(step_data: dict[str, Any], expected_spec: str) -> None:
...
def test_mapspec_zip_mode(step_data: dict[str, Any], expected_spec: str) -> None:
...
def test_mapspec_aggregate_mode(step_data: dict[str, Any], expected_spec: str) -> None:
...
def test_mapspec_should_return_none(step_data: dict[str, Any]) -> None:
...
def test_mapspec_raises_error_on_too_many_broadcast_inputs() -> None:
