...
@pytest.fixture
def base_pipeline_model(valid_workflow_dict: dict) -> FlowFuncPipelineModel:
    """Provides a validated FlowFuncPipelineModel instance."""
    try:
        return FlowFuncPipelineModel.model_validate(valid_workflow_dict)
...
@pytest.fixture
def first_step_model(base_pipeline_model: FlowFuncPipelineModel) -> StepModel:
...
def test_pipeline_creation_from_model_initializes_correctly(
    base_pipeline_model: FlowFuncPipelineModel,
...
def test_pipeline_with_new_import_path(tmp_path, monkeypatch) -> None:
    ...
    pipeline_model = FlowFuncPipelineModel.model_validate(pipeline_dict)
